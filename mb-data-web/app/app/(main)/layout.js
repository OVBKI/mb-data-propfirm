              ...
              <div ref={promoteModalRef} role="dialog" aria-modal="true" tabIndex={-1} aria-label={t('app.fundedModal.congrats')} onClick={e=>e.stopPropagation()} style={{...S.panel,padding:'28px',width:'500px',maxWidth:'100%',boxShadow:'0 30px 80px rgba(0,0,0,0.6)',position:'relative',overflow:'hidden'}}>
                ...
                <div style={{position:'relative'}}>
                  ...
                  <div style={{display:'flex',gap:'8px',justifyContent:'flex-end'}}>
                    ...
                    <button onClick={savePromote} style={{padding:'11px 22px',fontSize:13,fontWeight:700,background:'linear-gradient(135deg, var(--green) 0%, #2ed694 100%)',border:'none',color: 'var(--text-inverse)',borderRadius:'var(--radius)',cursor:'pointer',fontFamily:'inherit',boxShadow:'0 6px 18px var(--green-bg)',display:'flex',alignItems:'center',gap:'8px'}}>
