'use client'
// NebulaScene — 3D background adapted from Magic / 21st.dev "Horizon Hero".
// Starfield + animated nebula + parallax mountain layers + atmosphere, with
// UnrealBloom post-processing. Scroll/gsap choreography & DOM removed; runs as
// a self-contained animated canvas background. (three.js only)
...
export default function NebulaScene() {
  ...
  // stubs replacing removed scroll/loader state
  const setIsReady = () => {}
  const getLocation = () => {}
