...
export default function PropfirmComparator({ user }) {
  ...
  return (
    <div className="page-pad" style={{ maxWidth: '100%', margin: '0 auto', padding: '32px 24px 60px' }}>
      <div style={{ marginBottom: 28 }}>
        <div style={{ fontSize: 11, color: C.blueLight, letterSpacing: '0.16em', marginBottom: 10, textTransform: 'uppercase', fontWeight: 600 }}>
          Règles PropFirms
        </div>
        <div style={{ display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between', gap: 18, flexWrap: 'wrap', marginBottom: 8 }}>
          <h1 style={{ fontSize: 30, fontWeight: 700, letterSpacing: '-0.025em', margin: 0, marginBottom: 6, lineHeight: 1.1 }}>Comparateur PropFirms</h1>
          {isAdmin && (
            <span style={{
              display: 'inline-flex', alignItems: 'center', gap: 6,
              padding: '6px 12px', borderRadius: 8,
              background: 'rgba(45,111,255,0.10)', border: `1px solid rgba(45,111,255,0.4)`,
              fontSize: 11, fontWeight: 600, color: C.blueLight,
            }}>
