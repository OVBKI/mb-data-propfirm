...
export const FIRM_META = {
  ...
  'Lucid Trading': {
    // Réécrit en août 2026 sur le PDF officiel du checkout. La version précédente
    // décrivait un produit qui n'existe pas : « Lucid Static », un plan sans
    // trailing. Les quatre programmes réellement vendus sont LucidPro, LucidFlex,
    // LucidDaily et LucidDirect, et le drawdown est EOD partout — sauf LucidDaily,
    // où le type se choisit à l'achat.
    tagline: 'PropFirm futures EOD à quatre programmes : Pro, Flex, Daily et Direct.',
    description: 'Lucid Trading 2026 : quatre programmes (Pro, Flex, Daily, Direct), drawdown EOD, profit split 90/10, activation gratuite. Règles et FAQ.',
    intro: 'Lucid Trading est une PropFirm futures américaine qui vend quatre programmes distincts sur la même taille de compte, ce qui est rare : LucidPro (évaluation classique, consistance 40 % en financé, trois jours entre deux payouts), LucidFlex (aucune consistance une fois financé, mais cinq jours de profit minimum et un plan de scaling), LucidDaily (payouts quotidiens, et le seul programme du marché où le TYPE de drawdown — EOD ou intraday — se choisit au moment de l\'achat) et LucidDirect (financement direct, sans évaluation, avec une consistance stricte à 20 %). Le drawdown est un trailing EOD recalculé à la clôture, la limite de perte journalière est OPTIONNELLE sur les trois programmes évalués, et l\'activation du compte financé est gratuite. Profit split 90/10 dès le premier dollar, retrait minimum de 500 $, aucun frais de retrait.',
    website: 'https://lucidtrading.com',
    founded: '2023',
    country: 'États-Unis',
    platform: 'Rithmic · NinjaTrader · Tradovate',
    ddType: 'EOD (LucidDaily : EOD ou intraday, au choix à l\'achat)',
    splits: 'Profit split 90/10 dès le premier dollar.',
    keyFacts: [
      'Quatre programmes : LucidPro, LucidFlex, LucidDaily, LucidDirect',
      'Limite de perte journalière OPTIONNELLE (activée ou non à l\'achat)',
      'LucidScale : au-dessus du trail initial, la DLL devient 60 % du plus haut solde EOD',
    ...
    faqs: [
      ...
      },
      {
        ...
        a: 'LucidDaily paie quotidiennement, sans attendre un cycle. C\'est aussi le seul programme où le type de drawdown est une option d\'achat : on choisit EOD (recalculé à la clôture) ou intraday (qui suit le plus haut en temps réel) au moment du checkout. La consistance est de 50 % en évaluation et disparaît en financé.',
      },
      {
        q: 'La limite de perte journalière est-elle obligatoire chez Lucid ?',
        a: 'Non. Sur LucidPro, LucidFlex et LucidDaily elle s\'active ou non à l\'achat. Activée, elle vaut 600 $ en 25K, 1 200 $ en 50K, 1 800 $ en 100K et 2 700 $ en 150K. Désactivée, il ne reste que la limite de perte maximale. LucidDirect étant financé direct, la question ne se pose qu\'une fois le compte actif.',
      },
      {
        q: 'Qu\'est-ce que LucidScale ?',
        a: 'Au-dessus du seuil de trailing initial, la limite de perte journalière cesse d\'être un montant fixe : elle devient 60 % du plus haut solde de clôture atteint. Elle s\'élargit donc à mesure que le compte monte, au lieu de rester figée sur la taille de départ.',
      },
      {
      ...
      },
      {
        ...
        a: 'LucidDaily n\'a pas de plafond par demande de retrait mais un maximum de profit simulé par jour : 6 000 $ en 25K, 8 000 $ en 50K, 10 000 $ en 100K et 12 000 $ en 150K. L\'atteindre ou le dépasser fait passer le compte en LIVE automatiquement — c\'est donc une sortie du programme, pas un simple écrêtage.',
      },
      {
        q: 'Combien de payouts avant LucidLive ?',
        a: 'Cinq payouts sur LucidPro, LucidFlex et LucidDaily, six sur LucidDirect, donnent accès à LucidLive — un compte sur capital réel, autorisant l\'overnight et le week-end, interdits sur les quatre programmes achetables.',
      },
    ],
  },
  'Tradeify': {
