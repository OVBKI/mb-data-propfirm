...
export const PROPFIRM_RULES = {
  'Topstep': {
    ...
    rules: {
      ...
      'Drawdown journalier max': {'50k':'$1,000','100k':'$2,000','150k':'$4,500'},
      'Drawdown total max': {'50k':'$2,000','100k':'$3,000','150k':'$4,500'},
  ...
  'Apex Trader Funding': {
    plans: ['25k','50k','75k','100k','150k','250k'],
    rules: {
      'Objectif de profit': {'25k':'$1,500','50k':'$3,000','75k':'$4,250','100k':'$6,000','150k':'$9,000','250k':'$15,000'},
      'Drawdown trailing max': {'25k':'$1,500','50k':'$2,500','75k':'$2,750','100k':'$3,000','150k':'$5,000','250k':'$6,500'},
      'Jours de trading min': {'25k':'7j','50k':'7j','75k':'7j','100k':'7j','150k':'7j','250k':'7j'},
      'Positions overnight': {'25k':'Oui','50k':'Oui','75k':'Oui','100k':'Oui','150k':'Oui','250k':'Oui'},
      'Payout minimum': {'25k':'$500','50k':'$500','75k':'$500','100k':'$500','150k':'$500','250k':'$500'},
      'Délai payout': {'25k':'14j','50k':'14j','75k':'14j','100k':'14j','150k':'14j','250k':'14j'},
    }
  },
  'Bulenox': {
    ...
    rules: {
      ...
      'Drawdown journalier max': {'25k':'$500','50k':'$1,000','100k':'$2,000','150k':'$3,000','250k':'$5,000'},
      'Drawdown total max': {'25k':'$1,500','50k':'$2,500','100k':'$4,000','150k':'$5,000','250k':'$7,500'},
  ...
  'Lucid Trading': {
    ...
    rules: {
      ...
      'Drawdown total max': {'50k':'$2,500','100k':'$4,000','150k':'$5,000'},
      'Positions overnight': {'50k':'Non','100k':'Non','150k':'Non'},
  ...
  'Tradeify': {
    ...
    rules: {
      ...
      'Drawdown total max': {'25k':'$1,500','50k':'$2,500','100k':'$4,000','150k':'$5,000'},
  ...
  'Take Profit Trader': {
    ...
    rules: {
      ...
      'Drawdown total max': {'50k':'$2,000','100k':'$3,500','150k':'$5,000'},
      'Positions overnight': {'50k':'Non','100k':'Non','150k':'Non'},
      'Payout minimum': {'50k':'$500','100k':'$500','150k':'$500'},
      'Délai payout': {'50k':'15j','100k':'15j','150k':'15j'},
    }
  },
}
...
export const FIRM_SUGGESTIONS = ['Topstep','Apex Trader Funding','Bulenox','Lucid Trading','Tradeify','Take Profit Trader','TradeDay','Elite Trader Funding','Uprofit']
