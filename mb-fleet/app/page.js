  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
        ...
        <div>
          <div className="flex items-center justify-between mb-3">
            ...
            <Link href="/documents" className="text-sm text-brand-600 hover:underline">Tout voir →</Link>
          </div>
        ...
        <div>
          <div className="flex items-center justify-between mb-3">
            ...
            <Link href="/entretien" className="text-sm text-brand-600 hover:underline">Tout voir →</Link>
          </div>
      ...
      <div className="flex items-center justify-between mb-3">
        ...
        <Link href="/camions" className="text-sm text-brand-600 hover:underline">Gérer →</Link>
      </div>
